  ...
  const BelumSelesai = () => {
    ...
    return data ? (
      <div className="flex flex-col ">
        {data.map((poto, index) => (
          <div
            className="grid-cols-3 items-center justify-center grid m-2 border p-2 rounded-lg border-green-400"
            key={index}
          >
            ...
            <div className="flex justify-center gap-2">
              ...
              <button className="p-2 text-white font-semibold border rounded-lg bg-green-500">
                Shipment
              </button>
            </div>
          </div>
  ...
  const Berjalan = () => {
    ...
    return (
      <div className="flex justify-around p-3">
        ...
        <p>gambar</p>
        <p>nama produk</p>
        <button className="p-1 border rounded-lg border-green-400">
          Invoice
        </button>
      </div>
    );
    ...
    <div className="flex flex-col m-auto w-[90%] pb-[40px] border-green-600">
      ...
      <div className="border-1 border-green-500  border-b-0 flex justify-around bg-green-500 rounded-tr-lg rounded-tl-lg">
        <AdmBtn
          ...
          className={`${
            active == 1
              ? "bg-white text-green-400 hover:bg-white"
