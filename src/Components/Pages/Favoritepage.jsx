...
function Fav() {
    ...
    return (
        <>
            <div
                className="fixed text-center w-full bg-white  md:flex md:mx-6 md:my-12 md:items-center flex-around"
                style={{
                    boxShadow: "-12px 0px 37px 0px rgba(230, 235, 243, 0.5)",
                }}
            >
                <Logo className=" hidden " />
                <h1 className=" text-center font-bold my-4 text-[30px] md:w-[40%] ">Favorite</h1>
